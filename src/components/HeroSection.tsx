  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 max-w-4xl mx-auto">
        ...
        <p className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl text-muted-foreground font-body max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: "0.2s", opacity: 0 }}>
          Sua loja especializada em baterias. Produtos novos e seminovos, consertos e acessórios na região do ABC.
        </p>
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center animate-fade-in-up" style={{ animationDelay: "0.4s", opacity: 0 }}>
          <a
            href="#produtos"
            className="inline-flex items-center justify-center px-6 sm:px-8 py-3 bg-primary text-primary-foreground font-heading uppercase tracking-widest text-xs sm:text-sm font-semibold hover:bg-primary/90 transition-colors rounded-sm"
          >
            Ver Produtos
          </a>
          <a
